      ...
      <Accordion type="single" collapsible className="mt-6 w-full divide-y max-w-3xl">
        <AccordionItem value="item-0" className="border-b-0">
          ...
          <AccordionContent className="text-lg text-muted-foreground">
            Most no-code/low-code tools don't allow you to export the code. This means that you're
            always limited in customization and you're forced to host on their platform. Reweb is
            built with developers in mind. Once you're done building your website, you can export a
            fully functional Next.js & Tailwind codebase, customize it and host anywhere you want.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-1" className="border-b-0">
          ...
          <AccordionContent className="text-lg text-muted-foreground">
            Reweb is designed to have a minimal learning curve for developers. You don't need to
            learn new mental models or frameworks. It's built to work with popular frontend
        ...
        <AccordionItem value="item-2" className="border-b-0">
          ...
          <AccordionContent className="text-lg text-muted-foreground">
            ...
            of AI, write the copy on the editor and you're ready to go. Depending on your needs you
            can then customize further in the editor, or export the code for even more flexibility.
          </AccordionContent>
        </AccordionItem>
